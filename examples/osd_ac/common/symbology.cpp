...
namespace
{
    ...
    bool want_map = true;
    uint8_t osd_map_page_control = 0x04;
    quan::uav::osd::pal_ntsc_pos osd_map_position = { 0, 0, 0 };
    ...
    quan::uav::osd::pal_ntsc_pos osd_aircraft_battery_voltage_position = { 106,
            75, 75 };
    bool want_aircraft_battery_current = true;
    uint8_t osd_aircraft_battery_current_page_control = 0x07;
    quan::uav::osd::pal_ntsc_pos osd_aircraft_battery_current_position = { 106,
            60, 60 };
    bool want_aircraft_battery_remaining = true;
    uint8_t osd_aircraft_battery_remaining_page_control = 0x07;
    quan::uav::osd::pal_ntsc_pos osd_aircraft_battery_remaining_position = {
            118, 45, 45 };
    bool want_nav_wp = true;
    uint8_t osd_nav_wp_page_control = 0x07;
...
{
    return osd_altitude_page_control;
}
bool osd_show_altitude()
{
    return want_altitude && ((osd_show_altitude_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_heading_page()
{
    return osd_heading_page_control;
}
bool osd_show_heading()
{
    return want_heading && ((osd_show_heading_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_altitude_bar_page()
{
    return osd_altitude_bar_page_control;
}
bool osd_show_altitude_bar()
{
    return want_altitude
            && ((osd_show_altitude_bar_page() & get_osd_mode()) != 0);
}
float osd_get_altitude_bar_scale()
{
    return osd_altitude_bar_scale;
}
uint8_t osd_show_home_page()
{
    return osd_home_page_control;
}
bool osd_show_home()
{
    return want_home && ((osd_show_home_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_map_page()
{
    return osd_map_page_control;
}
bool osd_show_map()
{
    return want_map && ((osd_show_map_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_compass_page()
{
    return osd_compass_page_control;
}
bool osd_show_compass()
{
    return want_compass && ((osd_show_compass_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_gps_no_fix_page()
{
    return osd_gps_no_fix_page_control;
}
bool osd_show_gps_no_fix()
{
    return want_gps_no_fix
            && ((osd_show_gps_no_fix_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_afcl_horizon_page()
{
    return osd_afcl_horizon_page_control;
}
bool osd_show_afcl_horizon()
{
    return want_afcl_horizon
            && ((osd_show_afcl_horizon_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_gps_fix_type_page()
{
    return osd_gps_fix_type_page_control;
}
bool osd_show_gps_fix_type()
{
    return want_gps_fix_type
            && ((osd_show_gps_fix_type_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_gps_num_sats_page()
{
    return osd_gps_num_sats_page_control;
}
bool osd_show_gps_num_sats()
{
    return want_gps_num_sats
            && ((osd_show_gps_num_sats_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_gps_hdop_page()
{
    return osd_gps_hdop_page_control;
}
bool osd_show_gps_hdop()
{
    return want_gps_hdop && ((osd_show_gps_hdop_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_flight_mode_page()
{
    return osd_flight_mode_page_control;
}
bool osd_show_flight_mode()
{
    return want_flight_mode
            && ((osd_show_flight_mode_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_armed_mode_page()
{
    return osd_armed_mode_page_control;
}
bool osd_show_armed_mode()
{
    return want_armed_mode
            && ((osd_show_armed_mode_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_airspeed_page()
{
    return osd_airspeed_page_control;
}
bool osd_show_airspeed()
{
    return want_airspeed && ((osd_show_airspeed_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_groundspeed_page()
{
    return osd_groundspeed_page_control;
}
bool osd_show_groundspeed()
{
    return want_groundspeed
            && ((osd_show_groundspeed_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_latitude_page()
{
    return osd_latitude_page_control;
}
bool osd_show_latitude()
{
    return want_latitude && ((osd_show_latitude_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_longitude_page()
{
    return osd_longitude_page_control;
}
bool osd_show_longitude()
{
    return want_longitude && ((osd_show_longitude_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_baro_altitude_page()
{
    return osd_baro_altitude_page_control;
}
bool osd_show_baro_altitude()
{
    return want_baro_altitude
            && ((osd_show_baro_altitude_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_aircraft_battery_voltage_page()
{
    return osd_aircraft_battery_voltage_page_control;
}
bool osd_show_aircraft_battery_voltage()
{
    return want_aircraft_battery_voltage
            && ((osd_show_aircraft_battery_voltage_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_aircraft_battery_current_page()
{
    return osd_aircraft_battery_current_page_control;
}
bool osd_show_aircraft_battery_current()
{
    return want_aircraft_battery_current
            && ((osd_show_aircraft_battery_current_page() & get_osd_mode()) != 0);
}
uint8_t osd_show_aircraft_battery_remaining_page()
{
    return osd_aircraft_battery_remaining_page_control;
}
bool osd_show_aircraft_battery_remaining()
{
    return want_aircraft_battery_remaining
            && ((osd_show_aircraft_battery_remaining_page() & get_osd_mode())
                    != 0);
}
uint8_t osd_show_nav_wp_page()
{
    return osd_nav_wp_page_control;
}
bool osd_show_nav_wp()
{
    return want_nav_wp && ((osd_show_nav_wp_page() & get_osd_mode()) != 0);
}
...
bool init_values_from_flash()
{
    ...
    if (symtab.is_symbol_name_defined_in_flash("osd_map_pos"))
    {
        quan::three_d::vect<int32_t> v;
        if (quan::stm32::flash::get_flash_value("osd_map_pos", v))
        {
            osd_map_position.set_xpos(v.x);
            osd_map_position.set_ypos(v.y, v.z);
        }
    }
    ...
    {
        int16_t v;
        if (quan::stm32::flash::get_flash_value("osd_afcl_horizon_pitch_adj",
                v))
        {
    ...
    {
        bool v = false;
        if (quan::stm32::flash::get_flash_value("show_aircraft_battery_voltage",
                v))
        {
    ...
    if (symtab.is_symbol_name_defined_in_flash(
            "osd_aircraft_battery_voltage_pos"))
    {
        quan::three_d::vect<int32_t> v;
        if (quan::stm32::flash::get_flash_value(
                "osd_aircraft_battery_voltage_pos", v))
        {
    ...
    if (symtab.is_symbol_name_defined_in_flash(
            "osd_aircraft_battery_voltage_control"))
    {
        uint8_t v;
        if (quan::stm32::flash::get_flash_value(
                "osd_aircraft_battery_voltage_control", v))
        {
    ...
    {
        bool v = false;
        if (quan::stm32::flash::get_flash_value("show_aircraft_battery_current",
                v))
        {
    ...
    if (symtab.is_symbol_name_defined_in_flash(
            "osd_aircraft_battery_current_pos"))
    {
        quan::three_d::vect<int32_t> v;
        if (quan::stm32::flash::get_flash_value(
                "osd_aircraft_battery_current_pos", v))
        {
    ...
    if (symtab.is_symbol_name_defined_in_flash(
            "osd_aircraft_battery_current_control"))
    {
        uint8_t v;
        if (quan::stm32::flash::get_flash_value(
                "osd_aircraft_battery_current_control", v))
        {
    ...
    if (symtab.is_symbol_name_defined_in_flash(
            "show_aircraft_battery_remaining"))
    {
        bool v = false;
        if (quan::stm32::flash::get_flash_value(
                "show_aircraft_battery_remaining", v))
        {
    ...
    if (symtab.is_symbol_name_defined_in_flash(
            "osd_aircraft_battery_remaining_pos"))
    {
        quan::three_d::vect<int32_t> v;
        if (quan::stm32::flash::get_flash_value(
                "osd_aircraft_battery_remaining_pos", v))
        {
    ...
    if (symtab.is_symbol_name_defined_in_flash(
            "osd_aircraft_battery_remaining_control"))
    {
        uint8_t v;
        if (quan::stm32::flash::get_flash_value(
                "osd_aircraft_battery_remaining_control", v))
        {
            osd_aircraft_battery_remaining_page_control = v;
        }
    }

    if (symtab.is_symbol_name_defined_in_flash("show_nav_wp"))
    {
        bool v = false;
        if (quan::stm32::flash::get_flash_value("show_nav_wp", v))
        {
            want_nav_wp = v;
        }
    }

    if (symtab.is_symbol_name_defined_in_flash("osd_nav_wp_pos"))
    {
        quan::three_d::vect<int32_t> v;
        if (quan::stm32::flash::get_flash_value("osd_nav_wp_pos", v))
        {
            osd_nav_wp_position.set_xpos(v.x);
            osd_nav_wp_position.set_ypos(v.y, v.z);
        }
    }
    if (symtab.is_symbol_name_defined_in_flash("osd_nav_wp_control"))
    {
        uint8_t v;
        if (quan::stm32::flash::get_flash_value("osd_nav_wp_control", v))
        {
            osd_nav_wp_page_control = v;
        }
    }
    ...
    {
        uint32_t v;
        if (quan::stm32::flash::get_flash_value("osd_afcl_horizon_eye_distance",
                v))
        {
